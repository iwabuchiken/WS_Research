...
// require('./libs/Smarty.class.php');	//=> n/w
// require('./libs/SmartyBC.class.php');	//=>
...
function decipher_MultiTables() {

// 	$crypt = "PHYJSLYDDQFDZXPHSGZZQQEHXGKFNDRXUJUGIOCPHDXVKSBXHHUYPOOHDVPH";
	$crypt = "PHYJSLYDDQFDZXGASGZZQQEHXGKFNDRXUJUGIOCYTDXVKSBXHHUYPOOHDV";
	...
	//
	 ///////////////////////////////
	$ch = $crypt[$start_char].$crypt[$start_char + 1];
// 	$ch = $crypt[0].$crypt[1];
	
	printf("[%s : %d] ch => %s", __FILE__, __LINE__, $ch);
	
	echo "<br>"; echo "<br>";
	
	$res = Utils::decipher_Pref_Search($crypt, $ch, true);
	
	printf("[%s : %d] res =>", __FILE__, __LINE__);
	...
	//
	 ///////////////////////////////
	$ch = $crypt[$start_char + 2].$crypt[$start_char + 3];
...
function execute() {
	...
	*******************************/
	...
	//debug
	printf("[%s : %d] setup => done", __FILE__, __LINE__);
