...
set grid layerdefault   linetype 0 linecolor rgb "#bbbbbb"  linewidth 1.000,  linetype 0 linecolor rgb "#bbbbbb"  linewidth 1.000
set raxis
set key title "" font ",12"
...
GNUTERM = "wxt"
workdir = "C:/WORKS/WS/Eclipse_Luna/Learn_gnuplot/D-1"
plot [-pi:pi] (exp(x)+exp(-x))/2, -cosh(x), (exp(x)+exp(-x))/2+ (-cosh(x))
#    EOF
